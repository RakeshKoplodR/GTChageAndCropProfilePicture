...
extension UIImage{
    ...
    func fixOrientation() -> UIImage{
        ...
        let ctx = CGBitmapContextCreate(nil,CGImageGetWidth(self.CGImage), CGImageGetHeight(self.CGImage), CGImageGetBitsPerComponent(self.CGImage), 0, colorSpace,  bitmapInfo.rawValue)
