...
class GTUImageScrollView : UIScrollView,UIScrollViewDelegate{
   ...
   //  MARK - UIScrollViewDelegate
    ...
    func setMaxMinZoomScalesForCurrentBounds() {
        ...
        let yScale : CGFloat = boundsSize.height / _imageSize!.height;   // the scale needed to perfectly fit the image height-wise
        ...
        let xImageScale:CGFloat = maxScale * _imageSize!.width / boundsSize.width
        let yImageScale:CGFloat = maxScale * _imageSize!.height / boundsSize.width
    ...
    func setInitialContentOffset(){
        ...
        let boundsSize:CGSize = bounds.size
        let frameToCenter : CGRect = zoomView!.frame
    ...
    */
    func prepareToResize(){
        ...
        let boundsCenter:CGPoint = CGPointMake(CGRectGetMidX(bounds), CGRectGetMidY(bounds))
    ...
    func recoverFromResizing(){
        ...
        let boundsCenter:CGPoint = convertPoint(pointToCenterAfterResize!, toView: zoomView)
    ...
    func maximumContentOffset() -> CGPoint{
        ...
        let pointX:CGFloat = contentSize.width - bounds.width
        let pointy:CGFloat = contentSize.height - bounds.height
